package com.scalabledataarch.graphql.dao;
...
@Configuration
@EnableMongoRepositories(basePackages = "com.scalabledataarch.graphql.dao.repositories")
public class MongoConfig {

    @Value(value = "${grahqldaas.mongoUrl}")
    private String mongoUrl;

    @Value(value = "${grahqldaas.mongoDb}")
