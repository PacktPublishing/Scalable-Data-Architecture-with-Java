...
public class FileMoveToErrorTasklet implements Tasklet, StepExecutionListener {
    private final static Logger LOGGER = LoggerFactory.getLogger(FileMoveToErrorTasklet.class);
    private final EnvFolderProperty envFolderProperty;
    private Path filepath;

    public FileMoveToErrorTasklet(EnvFolderProperty envFolderProperty) {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        Path dest = Paths.get(envFolderProperty.getError() + File.separator + filepath.getFileName());
